...
TO_DATE('11/10/1964 22:45','DD/MM/YYYY HH24:MI')

Componentes do Grupo DESCHATEIE

Henry Van Angel  - RM81129
Fernando Ribeiro - RM
Marco Antonio Borges Oliveira - 81207
...
CREATE TABLE t_scp_consulta (
    ...
    cd_paciente_consulta   NUMBER NOT NULL,
...
CREATE TABLE t_scp_forma_pagamento (
    ...
    ds_forma_pagamento   VARCHAR2(40) NOT NULL
);
-- CONSTRAINTS
