		...
		<div class="container">
			<form action="cadastrarPaciente" method="POST">
				<div>
					...
					<div class="field">
						<div class="group_input">
							<label  class="label">Número de consultas realizadas:</label>
							<div class="control has-icons-left">
								<input class="input" type="number" placeholder="Número de consultas realizadas" name="consultas" id="consultas" required>
								<span class="icon is-small is-left">
									<i class="far fa-calendar-alt"></i>
								</span>
							</div>
